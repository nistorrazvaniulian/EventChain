  ...
  return (
    <div className="min-h-screen bg-gray-100 flex items-center justify-center px-4">
      <div className="bg-white rounded-xl shadow-md p-6 w-full max-w-md flex flex-col items-center text-center">
        ...
        <button
          onClick={handleLogin}
          className="w-full flex items-center justify-center gap-3 bg-blue-600 text-white font-semibold py-3 px-4 rounded-lg shadow hover:bg-blue-700 transition border-2 border-orange-300 mb-6"
        >
        ...
        <div className="flex flex-col gap-2 text-xs text-gray-500 px-2">
          <div className="flex items-start justify-center gap-2">
            ...
            <p>Adresa ta de email rămâne confidențială.</p>
          </div>
          <div className="flex items-start justify-center gap-2">
            <span className="text-orange-500">🔓</span>
            <p>Poți vedea biletele cumpărate și accesa evenimentele.</p>
          </div>
        </div>
      </div>
    </div>
